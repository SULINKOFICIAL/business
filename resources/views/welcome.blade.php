            ...
            <div class="card-body p-10 bg-[length:80%] [background-position:175%_25%] bg-no-repeat entry-callout-bg">
                <div class="flex flex-col justify-center gap-4">
                    <div class="flex -space-x-2">
                        <div class="flex">
                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-10" src="{{ asset('assets/media/avatars/300-4.png') }}"/>
                        </div>
                        <div class="flex">
                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-10" src="{{ asset('assets/media/avatars/300-1.png') }}"/>
                        </div>
                        <div class="flex">
                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-10" src="{{ asset('assets/media/avatars/300-2.png') }}"/>
                        </div>
                        <div class="flex">
            ...
            <div class="card-body lg:p-7.5 lg:pt-6 p-5">
                ...
                <div class="flex rounded-lg bg-gray-100 gap-10 p-5">
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex -space-x-2">
                            <div class="flex">
                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-4.png') }}"/>
                            </div>
                            <div class="flex">
                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-1.png') }}"/>
                            </div>
                            <div class="flex">
                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-2.png') }}"/>
                            </div>
                            <div class="flex">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex -space-x-2">
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-24.png') }}"/>
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-7.png') }}"/>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex -space-x-2">
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-3.png') }}"/>
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-8.png') }}"/>
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-9.png') }}"/>
                                                </div>
                                                <div class="flex">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex -space-x-2">
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-6.png') }}"/>
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-5.png') }}"/>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex -space-x-2">
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-10.png') }}"/>
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-11.png') }}"/>
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-12.png') }}"/>
                                                </div>
                                                <div class="flex">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex -space-x-2">
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-13.png') }}"/>
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-14.png') }}"/>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex -space-x-2">
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-15.png') }}"/>
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-16.png') }}"/>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex -space-x-2">
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-17.png') }}"/>
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-18.png') }}"/>
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-19.png') }}"/>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex -space-x-2">
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-20.png') }}"/>
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-21.png') }}"/>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex -space-x-2">
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-22.png') }}"/>
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-23.png') }}"/>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex -space-x-2">
                                                ...
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-25.png') }}"/>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex -space-x-2">
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-26.png') }}"/>
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-27.png') }}"/>
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-28.png') }}"/>
                                                </div>
                                                <div class="flex">
                                                    <span class="relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-3xs size-[30px] text-info-inverse ring-info-light bg-info">
                                                    +3
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex -space-x-2">
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-29.png') }}"/>
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-30.png') }}"/>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
